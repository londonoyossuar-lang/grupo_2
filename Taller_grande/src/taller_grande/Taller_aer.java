...
public class Taller_aer {
    ...
    private int saldo = 10000, saldoC = 20000000, retiroD = 2100000;
   ...
   public void retirar(){
       ...
       saldo-=valorO;
       JOptionPane.showMessageDialog(null,"retiro exitoso\n"+idvalidar()+"\n\n"+"nuevo saldo"+String.format("%,d,",saldo),"retiro realizado",JOptionPane.INFORMATION_MESSAGE);
       }catch (Exception e){
